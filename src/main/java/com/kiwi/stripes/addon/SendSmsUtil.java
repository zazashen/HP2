...
public class SendSmsUtil {
    ...
    static final String accessKeyId = "NjDodox5nN4gdRE5";
    static final String accessKeySecret = "dIT6nwM4VbFZFh58Fdpg4Pl6OnxQWQ";
    ...
    public static SendSmsResponse sendSms(String phoneNumber, String signName, String templateCode, String templateParam, String outId) throws ClientException {
        ...
        //request.setTemplateParam("{\"name\":\"Tom\", \"code\":\"4569\"}");
