  ...
  <strong>Warning!</strong> ${errMsg}
			...
			<div class="panel panel-info">
			  <div class="panel-heading">
			    <h3 class="panel-title">手机登录</h3>
			  </div>
			  <div class="panel-body">
			    <s:form beanclass="com.kiwi.stripes.actions.SignInAction">
									...
									<div class="input-group" style="margin-bottom:10px;">
									  ...
									  <input type="text" class="form-control" name="passWord" placeholder="passWord" aria-describedby="sizing-addon2">
									</div>
